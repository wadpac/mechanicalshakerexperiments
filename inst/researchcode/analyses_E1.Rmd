---
title: 'Analyses Experiment 1: Low sampling frequency constant dynamic range'
...
filename_experiment = paste0(datadir, "E1_lfcr.RData") 
...
save(correlation_matrices, file = paste0(datadir, "E1_cross_correlations_overall.RData"))

correlations_perShakerCondition <- computeCrossCorrelationsPerShakerCondition(data_low$data) 
save(correlations_perShakerCondition, file = paste0(datadir, "E1_cross_correlations_perShakerCondition.RData"))
```
...
ggplot2::ggsave(file=paste0(datadir, "plots/linegraph_E1_crosscorrelations.png"), line_plot, width = 10, height = 8, dpi = 900) #saves g
```
