...
for (condition in 1:length(fullmatrices)){
  ...
  png(height=1800, width=1800, file=paste0(datadir, paste0("heatmaps/E1/heatmap_E1_", condition, ".png")))
...
save(table_between, file = paste0(datadir, "E1_line_graph_data.RData"))
```
