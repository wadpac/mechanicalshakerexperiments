---
title: 'Analyses Experiment 6: Lack of standardized orientation high sampling frequency'
...
filename_experiment = paste0(datadir, "E6_bag.RData") 
...
```{r plot signals shaking direction E6, echo=FALSE}
plot_list <- list()
...
save(raw_spectra, file = paste0(datadir, "E6_frequency_spectra.RData"))
rm(raw.spectra_sd, raw.spectra_sd_corrected, raw.spectra_vm, sampling_frequency)

#load(paste0(datadir, "E6_frequency_spectra.RData"))
```
...
#cat("\nSaving data...")
save(comparison_values_sd, file = paste0(datadir, "E6_comparison_values_sd.RData")) 
...
#cat("\nSaving data...")
save(df_long, file = paste0(datadir, "E6_comparison_values_long_sd.RData"))
rm(peaks_sd)
```
...
#load(paste0(datadir, "E6_comparison_values_long_sd.RData"))
...
bxp_psd <- createBoxplot(df_long, bins_sd, outcome = "meanPSD", group = "brand", sampling_frequency = "E6") 
bxp_domFreq <- createBoxplot(df_long, bins_sd, outcome = "domFreq", group = "brand", sampling_frequency = "E6")

ggplot2::ggsave(file=paste0(datadir, "plots/boxplot_E6_meanPSD_sd.png"), bxp_psd, width = 10, height = 8, dpi = 900) #saves g
ggplot2::ggsave(file=paste0(datadir, "plots/boxplot_E6_domFreq_sd.png"), bxp_domFreq, width = 10, height = 8, dpi = 900) #saves g
```
...
save(correlation_matrices, file = paste0(datadir, "E6_cross_correlations_overall_sd.RData"))

correlations_perShakerCondition <- computeCrossCorrelationsPerShakerCondition(data_high$data) 
save(correlations_perShakerCondition, file = paste0(datadir, "E6_cross_correlations_perShakerCondition_sd.RData"))

#load(paste0(datadir, "E6_cross_correlations_overall_sd.RData"))
#load(paste0(datadir, "E6_cross_correlations_perShakerCondition_sd.RData"))
```
...
save(table_between, file = paste0(datadir, "E6_line_graph_data_sd.RData"))
...
ggplot2::ggsave(file=paste0(datadir, "plots/linegraph_E6_crosscorrelations_sd.png"), line_plot_SD, width = 10, height = 8, dpi = 900) #saves g
```
...
```
#### Mean frequency spectra
```{r Plot mean frequency spectrum sd corrected high sampling frequency, echo=FALSE}
plot(raw_spectra$mean_spectrumSDcorrected$x, raw_spectra$mean_spectrumSDcorrected$y, xlab = xlabel, ylab = ylabel, type = "l", xlim = XLIM, bty= "l", main = "Mean frequency spectrum (SD corrected) high sampling frequency and mixed dynamic range")
rm(mean.freqspec_sd_corrected)
```
#### Derive frequency bins
```{r Derive frequency bins sd corrected high sampling frequency, echo=FALSE}
...
```
#### Overlay all frequency spectra
```{r Overlay all spectra sd corrected high sampling frequency experiment, echo=FALSE}
...
```{r Plot spectra sd corrected high sampling frequency experiment, echo=FALSE}
...
#cat("\nSaving data...")
save(comparison_values_sdCorrected, file = paste0(datadir, "E6_comparison_values_sdCorrected.RData")) 
...
# Wide format: for both outcomes domFreq and meanPSD
load(paste0(datadir, "E6_comparison_values_sdCorrected.RData"))
df_wide <- data.frame()
...
#cat("\nSaving data...")
save(df_long, file = paste0(datadir, "E6_comparison_values_long_sd_corrected.RData"))
rm(peaks_sdCorrected)

#load(paste0(datadir, "E6_comparison_values_long_sd_corrected.RData"))
```

#### Statistical comparison: Mixed model analyses

##### Mean power spectral density: meanPSD ~ brand + bin + brand * bin
```{r Fit model meanPSD for high sd corrected sampling frequency experiment, echo=FALSE}
#load(paste0(datadir, "E6_comparison_values_long_sd_corrected.RData"))
...
##### Model assumption: normal distribution of residuals
```{r Mean PSD Model assumptions sd corrected high sampling frequency experiment, echo=FALSE}
ggpubr::ggqqplot(df_long, "meanPSD", facet.by = "bin", title = "QQ-plot mean power spectral density")
...
##### Model summary
```{r Model summary meanPSD sd corrected high sampling frequency experiment, echo=FALSE}
...
##### Pairwise comparisons
###### Bin
```{r Calculate contrasts bin meanPSD for sd corrected high sampling frequency, echo=FALSE}
...
##### Dominant frequency: domFreq ~ dynamic_range + bin + dynamic_range*bin
```{r Fit model domFreq for sd corrected high sampling frequency, echo=FALSE}
...
##### Model assumption: normal distribution of residuals
```{r Dom freq Model assumptions sd corrected high sampling frequency experiment, echo=FALSE}
ggpubr::ggqqplot(df_long, "domFreq", facet.by = "bin", title = "QQ-plot dominant frequency spectral density")
...
```
##### Model summary
```{r Model summary domFreq sd corrected high sampling frequency experiment, echo=FALSE}
...
##### Pairwise comparisons
###### Bin
```{r Calculate contrasts bin domFreq for sd corrected high sampling frequency experiment, echo=FALSE}
...
###### Brand
```{r Calculate contrasts brand domFreq for sd corrected high sampling frequency experiment, echo=FALSE}
...
###### Interaction effect
```{r Calculate contrasts interaction effect domFreq for sd corrected high sampling frequency experiment, echo=FALSE}
...
bxp_psd <- createBoxplot(df_long, bins_sdCorrected, outcome = "meanPSD", group = "brand", sampling_frequency = "E6") 
bxp_domFreq <- createBoxplot(df_long, bins_sdCorrected, outcome = "domFreq", group = "brand", sampling_frequency = "E6")

ggplot2::ggsave(file=paste0(datadir, "plots/boxplot_E6_meanPSD_sd_corrected.png"), bxp_psd, width = 10, height = 8, dpi = 900) #saves g
ggplot2::ggsave(file=paste0(datadir, "plots/boxplot_E6_domFreq_sd_corrected.png"), bxp_domFreq, width = 10, height = 8, dpi = 900) #saves g
```
...
save(correlation_matrices, file = paste0(datadir, "E6_cross_correlations_overall_sd_corrected.RData"))
...
save(correlations_perShakerCondition, file = paste0(datadir, "E6_cross_correlations_perShakerCondition_sd_corrected.RData"))

#load(paste0(datadir, "E6_cross_correlations_overall_sd_corrected.RData"))
#load(paste0(datadir, "E6_cross_correlations_perShakerCondition_sd_corrected.RData"))
```

#### Overall heatmap
```{r Heatmap sd corrected high sampling frequency, echo=FALSE, fig.width=14, fig.height=14}
fullmatrix <- correlation_matrices$correlationMatrix
...
#### Heatmap per shaker condition
```{r Heatmap sd corrected high sampling frequency per shaker condition, echo=FALSE, fig.width=14, fig.height=15}
fullmatrices <- correlations_perShakerCondition
...
```{r Calculate average maximum cross lagged correlation coefficients sd corrected high sampling frequency per shaker condition, include=FALSE}
avg_crosscor_between <- list()
avg_crosscor_within <- list()
...
```{r Between brand comparison sd corrected high sampling frequency, echo=FALSE}
table_between <- list()
...
```{r Line graph sd corrected high sampling frequency, echo=FALSE}
shaker_frequencies <- c(30, 40, 50, 62, 75, 87, 100, 112, 125, 137, 150, 160, 175, 187, 200, 212, 225, 237, 250)
groups <- rownames(table_between[[1]])
comparison <- rep(groups, length(shaker_frequencies))
correlations <- c()
...
ggplot2::ggsave(file=paste0(datadir, "plots/linegraph_E6_crosscorrelations_sd_corrected.png"), line_plot, width = 10, height = 8, dpi = 900) #saves g
```
...
```{r Plot mean frequency spectrum sd high sampling frequency, echo=FALSE}
plot(raw_spectra$mean_spectrumVM$x, raw_spectra$mean_spectrumVM$y, xlab = xlabel, ylab = ylabel, type = "l", xlim = XLIM, bty= "l", main = "Mean frequency spectrum (VM) high sampling frequency and mixed dynamic range")
rm(mean.freqspec_sd)
```
...
```{r Plot mean frequency spectrum VM high sampling frequency, echo=FALSE}
plot(raw_spectra$mean_spectrumVM$x, raw_spectra$mean_spectrumVM$y, xlab = xlabel, ylab = ylabel, type = "l", xlim = XLIM, bty= "l", main = "Mean frequency spectrum high sampling frequency and mixed dynamic range")
rm(mean_spectrumVM)
```

### Derive frequency bins
```{r Derive frequency bins VM high sampling frequency, echo=FALSE}
...
#### Overlay all frequency spectra
```{r Overlay all spectra vm high sampling frequency experiment, echo=FALSE}
...
```{r Plot spectra vm high sampling frequency experiment, echo=FALSE}
...
#cat("\nSaving data...")
save(comparison_values_VM, file = paste0(datadir, "E6_comparison_values_VM.RData")) 
...
#cat("\nSaving data...")
save(df_long, file = paste0(datadir, "E6_comparison_values_long_VM.RData"))
rm(peaks_VM)

#load(datadir, "E6_comparison_values_long_VM.RData")
```

#### Statistical comparison: Mixed model analyses

##### Mean power spectral density: meanPSD ~ brand + bin + brand * bin
```{r Fit model meanPSD for VM high sampling frequency experiment, echo=FALSE}
#load(paste0(datadir, "E6_comparison_values_long_sd_corrected.RData"))
...
##### Model assumption: normal distribution of residuals
```{r Mean PSD Model assumptions vm high sampling frequency experiment, echo=FALSE}
ggpubr::ggqqplot(df_long, "meanPSD", facet.by = "bin", title = "QQ-plot mean power spectral density")
...
##### Model summary
```{r Model summary meanPSD vm high sampling frequency experiment, echo=FALSE}
...
##### Pairwise comparisons
###### Bin
```{r Calculate contrasts bin meanPSD for vm high sampling frequency, echo=FALSE}
...
```
###### Brand
```{r Calculate contrasts brand meanPSD for vm high sampling frequency, echo=FALSE}
...
###### Interaction effect
```{r Calculate contrasts interaction effect mean PSD for vm high sampling frequency experiment, echo=FALSE}
...
##### Dominant frequency: domFreq ~ dynamic_range + bin + dynamic_range*bin
```{r Fit model domFreq for vm high sampling frequency, echo=FALSE}
...
##### Model assumption: normal distribution of residuals
```{r Dom freq Model assumptions vm high sampling frequency experiment, echo=FALSE}
ggpubr::ggqqplot(df_long, "domFreq", facet.by = "bin", title = "QQ-plot dominant frequency spectral density")
...
```
##### Model summary
```{r Model summary domFreq vm high sampling frequency experiment, echo=FALSE}
...
##### Pairwise comparisons
###### Bin
```{r Calculate contrasts bin domFreq for vm high sampling frequency experiment, echo=FALSE}
...
bxp_psd <- createBoxplot(df_long, bins_VM, outcome = "meanPSD", group = "brand", sampling_frequency = "E6") 
bxp_domFreq <- createBoxplot(df_long, bins_VM, outcome = "domFreq", group = "brand", sampling_frequency = "E6")

ggplot2::ggsave(file=paste0(datadir, "plots/boxplot_E6_meanPSD_VM.png"), bxp_psd, width = 10, height = 8, dpi = 900) #saves g
ggplot2::ggsave(file=paste0(datadir, "plots/boxplot_E6_domFreq_VM.png"), bxp_domFreq, width = 10, height = 8, dpi = 900) #saves g
```
...
save(correlation_matrices, file = paste0(datadir, "E6_cross_correlations_overall_VM.RData"))
...
save(correlations_perShakerCondition, file = paste0(datadir, "E6_cross_correlations_perShakerCondition_VM.RData"))

#load(paste0(datadir, "E6_cross_correlations_overall_VM.RData"))
#load(paste0(datadir, "E6_cross_correlations_perShakerCondition_VM.RData"))
```

#### Overall heatmap
```{r Heatmap VM high sampling frequency, echo=FALSE, fig.width=14, fig.height=14}
fullmatrix <- correlation_matrices$correlationMatrix
...
#### Heatmap per shaker condition
```{r Heatmap VM high sampling frequency per shaker condition, echo=FALSE, fig.width=14, fig.height=15}
fullmatrices <- correlations_perShakerCondition
...
```{r Calculate average maximum cross lagged correlation coefficients VM high sampling frequency per shaker condition, include=FALSE}
avg_crosscor_between <- list()
avg_crosscor_within <- list()
...
```{r Between brand comparison VM corrected high sampling frequency, echo=FALSE}
table_between <- list()
...
rm(avg_cor, tab, SD, sd, condition)
names(table_between) <- names(correlations_perShakerCondition)
save(table_between, file = paste0(datadir, "E6_line_graph_data_VM.RData"))
...
ggplot2::ggsave(file=paste0(datadir, "plots/linegraph_E6_crosscorrelations_VM.png"), line_plot_VM, width = 10, height = 8, dpi = 900) #saves g
```
