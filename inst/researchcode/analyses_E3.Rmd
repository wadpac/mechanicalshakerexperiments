...
#load(paste0(datadir, "E3_cross_correlations_perShakerCondition.RData"))
```
...
for (condition in 1:length(fullmatrices)){
    png(height=1800, width=1800, file=paste0(datadir, paste0("heatmaps/E3/heatmap_E3_", condition, ".png")))
...
save(table_between, file = paste0(datadir, "E3_line_graph_data.RData"))
