---
title: 'Analyses Experiment 3: Low sampling frequency mixed dynamic range'
...
filename_experiment = paste0(datadir, "E3_lfmr.RData") 
...
```{r Between dynamic range comparison low sampling frequency experiment, echo=FALSE}
table_between <- list()
...
```{r Line graph low sampling frequency, echo=TRUE}
