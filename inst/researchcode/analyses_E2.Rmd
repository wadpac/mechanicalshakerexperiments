...
#load(paste0(datadir, "E2_cross_correlations_perShakerCondition.RData"))
```
...
for (condition in 1:length(fullmatrices)){
    png(height=1800, width=1800, file=paste0(datadir, paste0("heatmaps/E2/heatmap_E2_", condition, ".png")))
...
save(table_between, file = paste0(datadir, "E2_line_graph_data.RData"))
```
