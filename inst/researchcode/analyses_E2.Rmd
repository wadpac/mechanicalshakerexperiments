---
title: 'Analyses Experiment 2: High sampling frequency constant dynamic range'
...
filename_experiment = paste0(datadir, "E2_hfcr.RData") 
...
save(correlation_matrices, file = paste0(datadir, "E2_cross_correlations_overall.RData"))

correlations_perShakerCondition <- computeCrossCorrelationsPerShakerCondition(data_high$data) 
save(correlations_perShakerCondition, file = paste0(datadir, "E2_cross_correlations_perShakerCondition.RData"))
```
...
ggplot2::ggsave(file=paste0(datadir, "plots/linegraph_E2_crosscorrelations.png"), line_plot, width = 10, height = 8, dpi = 900) #saves g
```
