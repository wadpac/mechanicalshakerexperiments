---
title: 'Analyses Experiment 4: High sampling rate mixed dynamic range'
...
```{r Between dynamic range comparison high sampling rate experiment, echo=FALSE}
table_between <- list()
...
```{r Line graph high sampling rate, echo=TRUE}
