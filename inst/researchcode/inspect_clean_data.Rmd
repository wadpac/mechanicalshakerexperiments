...
clean_data_high <- list(timeDomain = list(data = data_high_timeDomain, specifications = specifications_high_timeDomain), frequencyDomain = list(data = data_high_frequencyDomain, specifications_high_frequencyDomain))
