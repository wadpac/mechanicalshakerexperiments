...
This file presents the data from the five mechanical shaker experiments: ms_hfcr, ms_lfcr, ms_hfdr, ms_lfdr, ms_bag. Raw acceleration signals of each device per experiment are plotted for visual inspection.
...
Note that we restarted this high sampling frequency experiment (ms_hfcr), as we noticed that one GENEActiv device (GA_301) had come loose.
...
Visual inspection shows no typical shaker movements for the signal of aP_490 and aP_254.
