...
This file presents the data from the five mechanical shaker experiments: E1: ms_hrcr, E2: ms_lrcr, E3: ms_hrmr, E4: ms_lrmr, E5: ms_mrcr, and bag: ms_bag. We plotted raw triaxial acceleration signals of each device per experiment for visual inspection.
...
## Experiment 1 (E1): High sampling rate and constant dynamic range (hrcr)
...
## Experiment 2 (E2): Low sampling rate and constant dynamic range (lrcr)
...
## Experiment 3 (E3): High sampling rate and mixed dynamic range (hrmr)
...
## Experiment 4 (E4): Low sampling rate and mixed dynamic range (lrmr)
...
# Save a plot for each signal
ms_mrcr <- plotSignals(outputdir = paste0(datadir, "plots"), d = ms_lrmr, axes = c("x", "y", "z"))
```
