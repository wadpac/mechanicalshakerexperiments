...
This file presents the data from the five mechanical shaker experiments: E1: ms_hfcr, E2: ms_lfcr, E3: ms_hfmr, E4: ms_lfmr, and E5: ms_bag. We plotted raw triaxial acceleration signals of each device per experiment for visual inspection.
...
## Experiment 1 (E1): Low sampling frequency and constant dynamic range (lfcr)
...
```
## Experiment 2 (E2): High sampling frequency and constant dynamic range (hfcr)
...
```
## Experiment 3 (E3): Low sampling frequency and mixed dynamic range (lfmr)
...
## Experiment 4 (E4): High sampling frequency and mixed dynamic range (hfmr)
