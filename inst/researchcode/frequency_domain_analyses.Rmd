...
meanPSD_interaction_id_low <- lme4::lmer(meanPSD ~ 0 + bin + brand + bin*brand + (1 | serialnumber), REML = TRUE, data = df_long$low)

# Evaluate if adding a random intercept for frequency bin is necessary
meanPSD_interaction_id_bin_low <- lme4::lmer(meanPSD ~ 0 + bin + brand + bin*brand + (1 | serialnumber) + (1 | bin), REML = TRUE, data = df_long$low)
...
anova(meanPSD_interaction_id_low)
car::Anova(meanPSD_interaction_id_low)
...
domFreq_interaction_id_low <- lme4::lmer(domFreq ~ 0 + bin + brand + bin*brand + (1 | serialnumber), REML = TRUE, data = df_long$low)

# Evaluate if adding a random intercept for frequency bin is necessary
domFreq_interaction_id__bin_low <- lme4::lmer(domFreq ~ 0 + bin + brand + bin*brand + (1 | serialnumber) + (1 | bin), REML = TRUE, data = df_long$low)
...
anova(domFreq_interaction_id_low)
car::Anova(domFreq_interaction_id_low)
...
meanPSD_interaction_id_high <- lme4::lmer(meanPSD ~ 0 + bin + brand + bin*brand + (1 | serialnumber), REML = TRUE, data = df_long$high)

# Evaluate if adding a random intercept for frequency bin is necessary
meanPSD_interaction_id_bin_high <- lme4::lmer(meanPSD ~ 0 + bin + brand + bin*brand + (1 | serialnumber) + (1 | bin), REML = TRUE, data = df_long$high)
...
anova(meanPSD_interaction_id_high)
car::Anova(meanPSD_interaction_id_high)
...
domFreq_interaction_id_high <- lme4::lmer(domFreq ~ 0 + bin + brand + bin*brand + (1 | serialnumber), REML = TRUE, data = df_long$high)

# Evaluate if adding a random intercept for frequency bin is necessary
domFreq_interaction_id_bin_high <- lme4::lmer(domFreq ~ 0 + bin + brand + bin*brand + (1 | serialnumber) + (1 | bin), REML = TRUE, data = df_long$high)
...
anova(domFreq_interaction_id_high)
car::Anova(domFreq_interaction_id_high)
