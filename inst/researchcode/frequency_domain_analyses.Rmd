...
#Check how to rewrite the evaluation for adding a random intercept for frequency bin in terms of Wessel's code
...
meanPSD_intercept_id_low <- nlme::lme(meanPSD ~ brand + brand*bin, random = ~ 1|serialnumber, 
                                      method="ML", data = df_long$low)
domFreq_intercept_id_low <- nlme::lme(domFreq ~ brand  + brand*bin, random = ~ 1|serialnumber, 
                                      method="ML", data = df_long$low)

# Add random intercept for frequency bin (to adjust for the frequencies)
meanPSD_intercept_bin_low <- nlme::lme(meanPSD ~ brand + brand*bin, random = list(~ 1|serialnumber, ~ 1|bin),
                                           method="ML", data = df_long$low)
domFreq_intercept_bin_low <- nlme::lme(domFreq ~ brand + brand*bin, random = list(~ 1|serialnumber, ~ 1|bin),
                                           method="ML", data = df_long$low)
...
meanPSD_interaction_id_low <- lme4::lmer(meanPSD ~ 0 + bin + brand + bin*brand + (1 | serialnumber), data = df_long$low)
summary(meanPSD_interaction_id_low)
vcov(meanPSD_interaction_id_low)
```
...
domFreq_interaction_id_low <- lme4::lmer(domFreq ~ 0 + bin + brand + bin*brand + (1 | serialnumber), data = df_long$low)
summary(domFreq_interaction_id_low)
vcov(domFreq_interaction_id_low)
```
...
meanPSD_interaction_id_high <- lme4::lmer(meanPSD ~ 0 + bin + brand + bin*brand + (1 | serialnumber), data = df_long$high)
summary(meanPSD_interaction_id_high)
vcov(meanPSD_interaction_id_high)
```
...
domFreq_interaction_id_high <- lme4::lmer(domFreq ~ 0 + bin + brand + bin*brand + (1 | serialnumber), data = df_long$high)
summary(domFreq_interaction_id_high)
vcov(domFreq_interaction_id_high)
```
