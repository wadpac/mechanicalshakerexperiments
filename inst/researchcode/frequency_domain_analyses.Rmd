...
## Frequency bins
We derived frequency peaks from the mean frequency spectra for both experiments separately, and derived their associated frequencies in Hertz to indicate where the peaks were localized. We paired these peak locations and divided them by two to derive the frequency cut-offs for the bins to ensure these peaks fell within the frequency bins. Aggregated outcome values (i.e., dominant frequency and mean power spectral density) were calculated over the frequency bins for statistical comparison between brands.
...
This section presents the frequency spectrum plots of the device acceleration signals included in the analyses with the frequency bins indicated by red vertical lines overlayed in one and per signal separately.
...
domFreq_long_low <- domFreq_ms_wide_low %>%
  gather(key = "freqBin", value = "domFreq", t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11) %>%
  rstatix::convert_as_factor(id, freqBin, brand, sampling_frequency, dynamic_range)
meanPSD_long_low <- meanPSD_ms_wide_low %>%
  gather(key = "freqBin", value = "meanPSD", t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11) %>%
  rstatix::convert_as_factor(id, freqBin, brand, sampling_frequency, dynamic_range)
...
domFreq_long_high <- domFreq_ms_wide_high %>%
  gather(key = "freqBin", value = "domFreq", t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12) %>%
  rstatix::convert_as_factor(id, freqBin, brand, sampling_frequency, dynamic_range)
meanPSD_long_high <- meanPSD_ms_wide_high %>%
  gather(key = "freqBin", value = "meanPSD", t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12) %>%
  rstatix::convert_as_factor(id, freqBin, brand, sampling_frequency, dynamic_range)
