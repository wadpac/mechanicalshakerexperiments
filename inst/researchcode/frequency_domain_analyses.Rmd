...
g <- gridExtra::arrangeGrob(bxp_domfreq_low + theme(legend.position="none"), 
                            bxp_psd_low + theme(legend.position="bottom"), nrow=2) #generates g 
...
g_log <- gridExtra::arrangeGrob(bxp_domfreq_low_log + theme(legend.position="none"),
                                bxp_psd_low_log + theme(legend.position="bottom"),
...
plot(g)
rm(bxp_domfreq_low, bxp_psd_low, g)
```
...
plot(g_log)
rm(bxp_domfreq_low_log, bxp_psd_low_log, g_log)
```
...
g <- gridExtra::arrangeGrob(bxp_domfreq_high + theme(legend.position="none"), 
                            bxp_psd_high + theme(legend.position="bottom"), nrow=2) #generates g
...
g_log <- gridExtra::arrangeGrob(bxp_domfreq_high_log + theme(legend.position="none"),
                                bxp_psd_high_log + theme(legend.position="bottom"), 
                                nrow=2) #generates g_log
...
plot(g)
rm(bxp_domfreq_high, bxp_psd_high, g)
```
...
plot(g_log)
rm(bxp_domfreq_high_log, bxp_psd_high_log, g_log)
```
