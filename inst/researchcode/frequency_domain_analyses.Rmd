...
This section presents frequency spectra derived from the raw acceleration signals for both experiments separately. Additionaly, we used the mean frequency spectrum to the derive frequency bins for both experiments, over which aggregated outcome values (i.e., dominant frequency and mean power spectral density) were calculated for statistical comparison between brands.
...
This section presents the frequency spectrum plots, all device acceleration signals overlayed in one plot and for all signals separately, where the frequency bins are indicated by red vertical lines.
...
## Low sampling frequency experiment
This section presents the statistical comparison between the brand for the low sampling frequency experiment. The mixed models for the two outcomes mean power spectral density and dominant frequency are presented separately.
...
=======
##### Pairwise comparisons
>>>>>>> 8391114a42bfe053526d5da623dbae2c64673498
...
## High sampling frequency experiment
This section presents the statistical comparison between the brand for the high sampling frequency experiment. The mixed models for the two outcomes mean power spectral density and dominant frequency are presented separately.
