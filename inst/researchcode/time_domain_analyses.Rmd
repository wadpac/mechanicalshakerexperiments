...
```{r Compute cross-correlation matrices per shaker conditionn low sampling frequency experiment, include=FALSE}
correlations_low_perShakerCondition <- computeCrossCorrelationsPerShakerCondition(data_low) 
```

```{r Compute cross-correlation matrices per shaker condition high sampling frequency experiment, include=FALSE}
