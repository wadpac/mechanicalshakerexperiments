...
### Overall heatmap
```{r Heatmap low sampling frequency experiment, fig.width=14, fig.height=14, echo=FALSE}
...
```{r Heatmap low shaking frequency experiment per shaker condition, fig.width=14, fig.height=14, echo=FALSE}
...
#### ActiGraph
```{r Heatmap high sampling frequency experiment AG, fig.width=14, fig.height=14,  echo=FALSE}
