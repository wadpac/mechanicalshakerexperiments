...
data_high <- clean_data_high$data[as.numeric(clean_data_high$specifications$sampling_frequency) == "100"]
data_low <- clean_data_low$data[as.numeric(clean_data_low$specifications$sampling_frequency) == "25"]

specifications_high <- clean_data_high$specifications[as.numeric(clean_data_high$specifications$sampling_frequency) == "100",]
specifications_low <- clean_data_low$specifications[as.numeric(clean_data_low$specifications$sampling_frequency) == "25",]
...
In this section pairwise plots are generated for cross-correlations that are 2 SD lower than the mean cross-correlation (i.e., threshold).
...
crosscorr_low_threshold <- M - 2*SD
